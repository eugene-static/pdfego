...
const (
	...
	ShowTextWithIndividualGlyphPositioning Operator = "TJ" // Выводит текстовую строку, используя текущий шрифт и позицию, сдвигает текстовую позицию на ширину глифа + дополнительный сдвиг.
	...
	DashPattern     Operator = "d"  // Штриховой узор
